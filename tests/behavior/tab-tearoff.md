...
- **Cross-window adopt of a SOLE tab into an EXISTING window — NOW SHIPS (M09 F10 L3),
  ...
  the F10 L3 runtime pass, not here** — this spec's rows still assert only the F8 refusal of
  the sole-tab **tear-off / new-window** case (AC3 below), which stays a no-op window swap.
