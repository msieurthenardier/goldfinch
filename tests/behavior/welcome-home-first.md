...
- The engine-first order (`welcome-first-launch` steps 4–8); the handoff's own escape and Clear rows (`welcome-search-handoff` steps 4–6) — row 4 here reuses only its entry mechanism.
