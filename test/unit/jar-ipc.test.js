...
// Unit tests for src/main/jar-ipc.js. Shared stores, sessions, handler
// capture, trusted events, and event logging live in the in-memory harness.
...
const { appDb, flush, makeHarness, personal } = require('./helpers/jar-ipc-harness');
