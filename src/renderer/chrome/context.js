...
const IDS = {
  ...
  lightboxZoomLevel: 'lightbox-zoom-level',
  ...
  downloadsIndicator: 'downloads-indicator',
  ...
  playerCur: 'player-cur',
  playerDur: 'player-dur',
  playerPlay: 'player-play',
  playerPrev: 'player-prev',
  playerNext: 'player-next',
  kebab: 'kebab',
  addressChip: 'address-chip',
  star: 'star',
  automationIndicator: 'automation-indicator',
  automationIndicatorBadge: 'automation-indicator-badge',
