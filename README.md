...
or download **v0.11.6** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.11.6.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.11.6/Goldfinch-Setup-0.11.6.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.11.6-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.11.6/Goldfinch-0.11.6-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.11.6/Goldfinch-0.11.6-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.11.6.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.11.6/Goldfinch-0.11.6.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.11.6/goldfinch_0.11.6_amd64.deb) |
