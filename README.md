...
or download **v0.4.9** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.4.9.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.9/Goldfinch.Setup.0.4.9.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.4.9-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.9/Goldfinch-0.4.9-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.9/Goldfinch-0.4.9-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.4.9.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.9/Goldfinch-0.4.9.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.9/goldfinch_0.4.9_amd64.deb) |
