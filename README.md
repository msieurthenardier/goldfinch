...
or download **v0.16.2** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.16.2.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.2/Goldfinch-Setup-0.16.2.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.16.2-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.2/Goldfinch-0.16.2-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.2/Goldfinch-0.16.2-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.16.2.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.2/Goldfinch-0.16.2.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.2/goldfinch_0.16.2_amd64.deb) |
