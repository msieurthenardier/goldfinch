...
or download **v0.14.1** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.14.1.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.14.1/Goldfinch-Setup-0.14.1.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.14.1-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.14.1/Goldfinch-0.14.1-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.14.1/Goldfinch-0.14.1-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.14.1.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.14.1/Goldfinch-0.14.1.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.14.1/goldfinch_0.14.1_amd64.deb) |
