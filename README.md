...
or download **v0.13.3** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.13.3.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.3/Goldfinch-Setup-0.13.3.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.13.3-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.3/Goldfinch-0.13.3-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.3/Goldfinch-0.13.3-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.13.3.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.3/Goldfinch-0.13.3.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.3/goldfinch_0.13.3_amd64.deb) |
