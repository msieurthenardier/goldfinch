...
or download **v0.13.4** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.13.4.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.4/Goldfinch-Setup-0.13.4.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.13.4-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.4/Goldfinch-0.13.4-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.4/Goldfinch-0.13.4-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.13.4.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.4/Goldfinch-0.13.4.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.13.4/goldfinch_0.13.4_amd64.deb) |
