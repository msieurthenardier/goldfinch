...
or download **v0.16.5** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.16.5.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.5/Goldfinch-Setup-0.16.5.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.16.5-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.5/Goldfinch-0.16.5-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.5/Goldfinch-0.16.5-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.16.5.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.5/Goldfinch-0.16.5.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.16.5/goldfinch_0.16.5_amd64.deb) |
