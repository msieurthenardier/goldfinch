...
or download **v0.4.8** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.4.8.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.8/Goldfinch.Setup.0.4.8.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.4.8-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.8/Goldfinch-0.4.8-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.8/Goldfinch-0.4.8-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.4.8.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.8/Goldfinch-0.4.8.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.8/goldfinch_0.4.8_amd64.deb) |
