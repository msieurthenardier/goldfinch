...
or download **v0.7.0** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.7.0.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.7.0/Goldfinch.Setup.0.7.0.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.7.0-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.7.0/Goldfinch-0.7.0-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.7.0/Goldfinch-0.7.0-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.7.0.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.7.0/Goldfinch-0.7.0.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.7.0/goldfinch_0.7.0_amd64.deb) |
