...
or download **v0.4.7** directly:

| Platform | Installer |
|----------|-----------|
| **Windows** | [Goldfinch Setup 0.4.7.exe](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.7/Goldfinch.Setup.0.4.7.exe) |
| **macOS** (Apple Silicon) | [Goldfinch-0.4.7-arm64.dmg](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.7/Goldfinch-0.4.7-arm64.dmg) · [.zip](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.7/Goldfinch-0.4.7-arm64-mac.zip) |
| **Linux** | [Goldfinch-0.4.7.AppImage](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.7/Goldfinch-0.4.7.AppImage) · [.deb](https://github.com/msieurthenardier/goldfinch/releases/download/v0.4.7/goldfinch_0.4.7_amd64.deb) |
