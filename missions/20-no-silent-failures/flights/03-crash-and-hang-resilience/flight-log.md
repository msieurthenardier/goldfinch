...
- **Operator ruling on H5 (2026-09-17, pre-debrief)**: the paused window's black chrome area is an accepted edge case — "we can live with it". Recorded as a Known Issue / backlog item, not a recommendation; the two directions stay on file for whenever it is picked up.
