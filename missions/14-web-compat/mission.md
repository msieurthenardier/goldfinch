...
- [ ] Flight 3 *(optional)*: **Alignment** — vibe coding session for hands-on testing against live sites: fullscreen feel, the witnessed live GitHub OAuth sign-in, auth prompts, and adjustments that benefit from real-time human judgment.
